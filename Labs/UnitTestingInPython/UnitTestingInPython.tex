...
\objective{Convey the importance of unit testing in code, especially in the corporate world. Unit testing in python is easy, valulable and powerful. Any software development position will appreciate a developer who is able to accurately test their code.}
